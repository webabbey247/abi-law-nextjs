          ...
          <div className=" py-16 flex flex-col justify-start gap-4 bg-white max-w-120">
            ...
            <div className="flex flex-col gap-2">
              <p className="font-body text-[1rem] tracking-[-0.005em] leading-[1.7] font-normal text-[#262b40]">
                Have a legal question or need to discuss your case? Complete
                this form and one of our attorneys will respond within 24–48
                hours. For urgent matters, call or email us directly.
              </p>
              <p className="font-body text-[1rem] tracking-[-0.005em] leading-[1.7] font-normal text-[#262b40]">
                We can't wait to talk to you about how we can help your child
                grow their emotional wellbeing.
              </p>
            </div>
            <div className="flex flex-col gap-4 mt-2">
              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="flex flex-col gap-0.5">
                  ...
                  <a
                    href="mailto:support@abilaw.co.uk"
                    className="font-body text-[0.95rem] text-text hover:text-primary transition-colors duration-200"
                  >
                    support@abilaw.co.uk
                  </a>
                </div>
                <div className="flex flex-col gap-0.5">
                  <span className="font-body text-[0.75rem] tracking-[0.07em] uppercase font-medium text-[#057e5b]">
                ...
                <div className="flex flex-col gap-0.5">
                  <span className="font-body text-[0.72rem] tracking-[0.07em] uppercase font-medium text-[#057e5b]">
                    Hours
                  </span>
                  <span className="font-body text-[0.95rem] text-text">
      ...
      <section id="faqs" className="py-28 px-8 md:px-20 bg-[#F9F9FB]">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_2fr] gap-24 items-start">
          <div className="lg:sticky lg:top-24 space-y-4">
            ...
            <p className="font-body text-[1rem] tracking-[-0.005em] leading-[1.7] font-normal text-[#262b40]">
              Everything you need to know about working with our firm.
